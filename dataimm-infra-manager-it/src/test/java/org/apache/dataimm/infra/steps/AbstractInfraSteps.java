 ...
 * under the License.
 */
package org.apache.dataimm.infra.steps;

import static org.apache.dataimm.infra.Solr.AUDIT_LOGS_COLLECTION;
import static org.apache.dataimm.infra.Solr.HADOOP_LOGS_COLLECTION;
import static org.apache.dataimm.infra.TestUtil.doWithin;
import static org.apache.dataimm.infra.TestUtil.getDockerHost;
import static org.apache.dataimm.infra.TestUtil.runCommand;
...
import org.apache.dataimm.infra.InfraClient;
import org.apache.dataimm.infra.S3Client;
import org.apache.dataimm.infra.Solr;
...
public abstract class AbstractInfraSteps {
  ...
  public String getLocalDataFolder() {
    return dataimmFolder + "/dataimm-infra/dataimm-infra-manager/docker/test-out";
  }

  public String getInfraManagerConfDir() {
    return dataimmFolder + "/dataimm-infra/dataimm-infra-manager/target/package/conf";
  }
  ...
  public void initDockerContainer() throws Exception {
    ...
    dataimmFolder = new File(location.toURI()).getParentFile().getParentFile().getParentFile().getParent();
    ...
    shellScriptLocation = dataimmFolder + "/dataimm-infra/dataimm-infra-manager/docker/infra-manager-docker-compose.sh";
    logger.info("Create new docker container for testing Dataimm Infra Manager ...");
  ...
  private void checkInfraManagerReachable() {
    ...
    doWithin(30, "Start Dataimm Infra Manager", infraClient::getJobs);
    logger.info("Dataimm Infra Manager is up and running");
  }
  ...
  protected SolrInputDocument addDocument(OffsetDateTime logtime) {
    ...
    solrInputDocument.addField("reqUser", "dataimm-qa");
    ...
    solrInputDocument.addField("ugi", "dataimm-qa (auth:SIMPLE)");
    solrInputDocument.addField("host", "logfeeder.apache.org");
    solrInputDocument.addField("action", "getfileinfo");
    solrInputDocument.addField("log_message", "allowed=true\tugi=dataimm-qa (auth:SIMPLE)\tip=/192.168.64.102\tcmd=getfileinfo\tsrc=/ats/active\tdst=null\tperm=null\tproto=rpc\tcallerContext=HIVE_QUERY_ID:dataimm-qa_20160317200111_223b3079-4a2d-431c-920f-6ba37ed63e9f");
    ...
    solrInputDocument.addField("req_caller_id", "HIVE_QUERY_ID:dataimm-qa_20160317200111_223b3079-4a2d-431c-920f-6ba37ed63e9f");
