 ...
 * under the License.
 */
package org.apache.dataimm.infra.solr.metrics;
...
public class MetricsIT {
  ...
  public static void setupMetricsServer() throws Exception {
    ...
    String dataimmFolder = new File(location.toURI()).getParentFile().getParentFile().getParentFile().getParent();

    // TODO: use the same containers as dataimm-infra-manager-it
    shellScriptLocation = dataimmFolder + "/dataimm-infra/dataimm-infra-solr-plugin/docker/infra-solr-docker-compose.sh";
    logger.info("Creating new docker containers for testing Dataimm Infra Solr Metrics plugin ...");
