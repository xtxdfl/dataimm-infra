...
INFRA_MANAGER_SOURCE="/usr/lib/dataimm-infra-manager/bin/infraManager.sh"
INFRA_MANAGER_CONF_LINK_DIR="/etc/dataimm-infra-manager"
INFRA_MANAGER_CONF_LINK_NAME="$INFRA_MANAGER_CONF_LINK_DIR/conf"
INFRA_MANAGER_CONF_SOURCE="/usr/lib/dataimm-infra-manager/conf"
