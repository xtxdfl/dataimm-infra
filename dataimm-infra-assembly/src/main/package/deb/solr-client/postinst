...
SOLR_CLOUD_CLI_SOURCE="/usr/lib/dataimm-infra-solr-client/solrCloudCli.sh"

SOLR_INDEX_TOOL_LINK_NAME="/usr/bin/infra-lucene-index-tool"
SOLR_INDEX_TOOL_SOURCE="/usr/lib/dataimm-infra-solr-client/solrIndexHelper.sh"

SOLR_DATA_MANAGER_LINK_NAME="/usr/bin/infra-solr-data-manager"
SOLR_DATA_MANAGER_SOURCE="/usr/lib/dataimm-infra-solr-client/solrDataManager.py"
