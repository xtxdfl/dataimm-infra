...
public class DataimmSolrCloudClientTest {

  private DataimmSolrCloudClient underTest;
  ...
  @Before
  public void setUp() {
    DataimmSolrCloudClientBuilder builder = new DataimmSolrCloudClientBuilder();
  ...
  @Test(expected = DataimmSolrCloudClientException.class)
