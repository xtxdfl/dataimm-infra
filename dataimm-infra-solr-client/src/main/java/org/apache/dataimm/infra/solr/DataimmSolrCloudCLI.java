...
public class DataimmSolrCloudCLI {

  private static final Logger logger = LoggerFactory.getLogger(DataimmSolrCloudCLI.class);
  ...
  private static final String CMD_LINE_SYNTAX =
    "\n./solrCloudCli.sh --create-collection -z host1:2181,host2:2181/dataimm-solr -c collection -cs conf_set"
      + "\n./solrCloudCli.sh --upload-config -z host1:2181,host2:2181/dataimm-solr -d /tmp/myconfig_dir -cs config_set"
      + "\n./solrCloudCli.sh --download-config -z host1:2181,host2:2181/dataimm-solr -cs config_set -d /tmp/myonfig_dir"
      + "\n./solrCloudCli.sh --check-config -z host1:2181,host2:2181/dataimm-solr -cs config_set"
      + "\n./solrCloudCli.sh --create-shard -z host1:2181,host2:2181/dataimm-solr -c collection -sn myshard"
      + "\n./solrCloudCli.sh --remove-admin-handlers -z host1:2181,host2:2181/dataimm-solr -c collection"
      + "\n./solrCloudCli.sh --dump-collections -z host1:2181,host2:2181/dataimm-solr -o collection-data.json"
      + "\n./solrCloudCli.sh --create-znode -z host1:2181,host2:2181 -zn /dataimm-solr"
      + "\n./solrCloudCli.sh --check-znode -z host1:2181,host2:2181 -zn /dataimm-solr"
      + "\n./solrCloudCli.sh --delete-znode -z host1:2181,host2:2181 -zn /dataimm-solr"
      + "\n./solrCloudCli.sh --transfer-znode -z host1:2181,host2:2181 -cps /dataimm-solr -cpd /dataimm-solr-backup"
      + "\n./solrCloudCli.sh --cluster-prop -z host1:2181,host2:2181/dataimm-solr -cpn urlScheme -cpn http"
      + "\n./solrCloudCli.sh --secure-znode -z host1:2181,host2:2181 -zn /dataimm-solr -su logsearch,atlas,ranger --jaas-file /etc/myconf/jaas_file"
      + "\n./solrCloudCli.sh --unsecure-znode -z host1:2181,host2:2181 -zn /dataimm-solr --jaas-file /etc/myconf/jaas_file"
      + "\n./solrCloudCli.sh --secure-solr-znode -z host1:2181,host2:2181 -zn /dataimm-solr -su logsearch,atlas,ranger --jaas-file /etc/myconf/jaas_file"
      + "\n./solrCloudCli.sh --setup-kerberos-plugin -z host1:2181,host2:2181 -zn /dataimm-solr --security-json-location /etc/infra-solr/conf/security.json"
      + "\n./solrCloudCli.sh --" + SET_AUTO_SCALING_COMMAND + " -z host1:2181,host2:2181 -zn /dataimm-solr [--" + AUTO_SCALING_JSON_LOCATION + "|--" + AUTO_SCALING_JSON_LOCATION_SHORT + "] /etc/infra-solr/conf/autoscaling.json\n ";
  ...
  public static void main(String[] args) {
    ...
    final Option zkConnectStringOption = Option.builder("z")
      ...
      .numberOfArgs(1)
      .argName("host:port,host:port[/dataimm-solr]")
      .build();
    ...
    DataimmSolrCloudClient solrCloudClient = null;
    ...
    try {
      ...
      DataimmSolrCloudClientBuilder clientBuilder = new DataimmSolrCloudClientBuilder()
      ...
      switch (command) {
        ...
        case SET_AUTO_SCALING_COMMAND:
          ...
          break;
        default:
          throw new DataimmSolrCloudClientException(String.format("Not found command: '%s'", command));
      }
    } catch (Exception e) {
  ...
  private static void validateRequiredOptions(CommandLine cli, String command, Option... optionsToValidate)
    throws DataimmSolrCloudClientException {
    ...
    if (!requiredOptions.isEmpty()) {
      throw new DataimmSolrCloudClientException(
