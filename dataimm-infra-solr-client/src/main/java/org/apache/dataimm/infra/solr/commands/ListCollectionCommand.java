...
public class ListCollectionCommand extends AbstractSolrRetryCommand<CollectionAdminRequest.List, List<String>> {
  ...
  @Override
  public List<String> handleResponse(CollectionAdminResponse response, DataimmSolrCloudClient client) throws Exception {
  ...
  @Override
  public CollectionAdminRequest.List createRequest(DataimmSolrCloudClient client) {
