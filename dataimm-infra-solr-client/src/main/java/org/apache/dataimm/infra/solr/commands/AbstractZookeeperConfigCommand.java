...
public abstract class AbstractZookeeperConfigCommand<RESPONSE> extends AbstractZookeeperRetryCommand<RESPONSE> {
  ...
  protected abstract RESPONSE executeZkConfigCommand(ZkConfigManager zkConfigManager, DataimmSolrCloudClient client)
    throws Exception;

  @Override
  protected RESPONSE executeZkCommand(DataimmSolrCloudClient client, SolrZkClient zkClient, SolrZooKeeper solrZooKeeper) throws Exception {
