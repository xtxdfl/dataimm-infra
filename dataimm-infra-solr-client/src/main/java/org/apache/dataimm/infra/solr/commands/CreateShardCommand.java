...
public class CreateShardCommand extends AbstractSolrRetryCommand<CollectionAdminRequest.CreateShard, String> {
  ...
  @Override
  public String handleResponse(CollectionAdminResponse response, DataimmSolrCloudClient client) throws Exception {
    return shardName;
  }

  @Override
  public CollectionAdminRequest.CreateShard createRequest(DataimmSolrCloudClient client) {
    return CollectionAdminRequest.createShard(client.getCollection(), shardName);
  }

  @Override
  public String errorMessage(DataimmSolrCloudClient client) {
