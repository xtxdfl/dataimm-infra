...
public class CheckZnodeZkCommand extends AbstractZookeeperRetryCommand<Boolean> {
  ...
  @Override
  protected Boolean executeZkCommand(DataimmSolrCloudClient client, SolrZkClient zkClient, SolrZooKeeper solrZooKeeper) throws Exception {
    try {
      return zkClient.exists(this.znode, false);
    } catch (KeeperException e) {
      throw new DataimmSolrCloudClientException("Exception during checking znode, " +
